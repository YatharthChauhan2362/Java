...
// Sometimes our program grows in size, and we want to separate the logic of the
// main method from the other methods.
// For instance, if we calculate the average of a number pair 5 times, we can
// use methods to avoid repeating the logic. [DRY – Don’t Repeat Yourself]

// Syntax of a Method
// A method is a function written inside a class. Since Java is an
// object-oriented language, we need to write the method inside some class.
...
// The sum of two values integer values(a and b) is stored in another integer
// value named 'c'.
// mySum returns c.
...
// The values from the method call (a and b) are copied to the a and b of the
// function mySum. Thus even if we modify the values a and b inside the method,
// the values in the main method will not change.
...
// Note: In the case of Arrays, the reference is passed. The same is the case
// for object passing to methods.

public class _20_Methods {
    ...
    public static void main(String[] args) {
        ...
        // _20_Methods obj = new _20_Methods();
        // c = obj.logic(a, b);
