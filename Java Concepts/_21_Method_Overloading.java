...
// In Java, it is possible for a class to contain two or more methods with the
// same name but with different parameters. Such methods are called Overloaded
// methods.
...
// These two methods are overloaded because they have the same name but their
// return is different.
// The return type of 1st method is int while the return type of the other
// method is double.
...
public class _21_Method_Overloading {
    static void foo() {
